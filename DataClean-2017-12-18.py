...
n_users = user_log_data.user_id.unique().shape[0]
n_sellers = user_log_data.seller_id.unique().shape[0]
...
#
# tempResult = tempResult[tempResult['clickCounts'] < 300]
# print(tempResult.describe())
#
# tempResult['prob'] = tempResult['clickCounts']*0.02 + tempResult['addToCartCounts']*0.1 + tempResult['buyCounts']*0.5 + tempResult['addFavCounts']*0.3
